...
var main = new Vue({
    ...
    events: {
        'onDeleteItem':function() {
            ...
            abp.services.app.equip.delete($this.selectNode.id);
        }
    },
    methods: {
        newItem: function() {
                    ...
                    $this.tree = $.fn.zTree.init($("#treeCatalog"), {
                        ...
                        callback: {
                            onClick: function (event, treeId, treeNode, clickFlag) {
                                ...
                                abp.services.app.equip.get($this.selectNode.id)
                                    .done(function(m) {
                                        $this.item = m;
                                        $("#equipContent").html( m.content);
                                    });
                            }
                        }
                    }, m);
        ...
        saveContent:function() {
            ...
            abp.services.app.equip.saveAsync($this.item)
                .done(function (m) {
