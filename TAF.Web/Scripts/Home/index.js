...
Path.map("#rechargeRecords").to(function () { loadPage("/RechargeRecord/RechargeRecordList", "车辆管理", "油料分配记录", "#menuRechargeRecords", false); });
Path.map("#applicationForBunkerAs").to(function () { loadPage("/ApplicationForBunkerA/ApplicationForBunkerAList", "车辆管理", "加油卡加油申请单", "#menuApplicationForBunkerAs", false); });
Path.map("#applicationForAuditA").to(function () { loadPage("/ApplicationForBunkerA/ApplicationForAuditAList", "车辆管理", "加油卡加油审批单", "#menuApplicationForAuditA", false); });
