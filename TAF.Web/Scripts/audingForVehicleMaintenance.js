var main = new Vue({
    ...
    methods: {
        ...
        refuse: function () {
            var $this = this;
            abp.services.app.applyForVehicleMaintenance.auding({Key:$this.item.id,Value:2,Item3:$this.item.note2})
                .done(function (m) {
                    $this.query(0);
        ...
        approve: function () {
            var $this = this;
            abp.services.app.applyForVehicleMaintenance.auding({Key:$this.item.id,Value:1,Item3:$this.item.note2})
                .done(function (m) {
                    $this.query(0);
                    $("#modifyApplyForVehicleMaintenanceDialog").modal("hide");
                })
