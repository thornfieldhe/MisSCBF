...
namespace SCBF.Web.Controllers
{
    ...
    public class BudgetReceiptController : TAFControllerBase
    {
        ...
        {
            this.UploadFile(DictionaryCategory.Attachment_BudgetReceipt, new string[] { }, this.budgetReceiptAppService.LoadBudgetReceiptFile1);
        ...
        {
            this.UploadFile(DictionaryCategory.Attachment_BudgetReceipt, new string[] { }, this.budgetReceiptAppService.LoadBudgetReceiptFile2);
            return new JsonResult() { Data = "OK" };
        }
        ...
        {
            this.UploadFile(DictionaryCategory.Attachment_BudgetReceipt, new string[] { }, this.budgetReceiptAppService.LoadBudgetReceiptFile3);
            return new JsonResult() { Data = "OK" };
        }
